...
<div id="boxes">
    ...
    <div id="dialog2" class="window">
        ...
        <form action="<?=base_url('home/login')?>" method="POST">
            ...
            <span class="login">SENHA</span><br /><input name="senha" type="text" class="field7" /><span class="login2"> <a href="#">(Esqueceu?)</a></span>
    ...
    <div id="header_top">
        <div class="container_24">
            ...
            <div class="grid_8 prefix_5">
                ...
                ?>
                Usuário logado - precisa arrumar aqui - <a href="<?=base_url('usuario/logout')?>">[Logout]</a>
                <?php
                    }else{
                ?>
