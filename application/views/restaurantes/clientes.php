    ...
    <div class="grid_20">
    	...
    	<div class="grid_2 menu">
    		<ul>
    			...
    			<li class="selected"><a href="#"><img src="/assets/img/icones/hostess/ico-clientes.png" width="41" height="51"><br><br>Clientes</a></li>
    	...
    	<div class="grid_18">
    		<div class="header">
    			...
    			<div class="grid_12 title">CLIENTES</div>
